LinterSlimLint = require '../lib/linter-slim-lint'
  ...
  describe "when the linter-slim-lint:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        linterSlimLintElement = workspaceElement.querySelector('.linter-slim-lint')
        expect(linterSlimLintElement).toExist()

        linterSlimLintPanel = atom.workspace.panelForItem(linterSlimLintElement)
